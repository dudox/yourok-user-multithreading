 ...
 * 
 * Producer thread.
 * When run, it will send a list of 2 users to the broker.
 * Important note here is we registered the 'value.serializer' property 
 * of the producer with our custom serializer.
 * 
 * @author Andrea Muti
 * created: 26 nov 2017
 *
...
public class UserProducerThread implements Runnable {
	...
	private static Properties createProducerConfig(String brokers) {
		...
		props.put("value.serializer", "muti.kafka.custom.serializer.user.UserSerializer");
